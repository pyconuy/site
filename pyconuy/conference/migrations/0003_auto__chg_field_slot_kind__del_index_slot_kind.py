...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Slot.kind' to match new field type.
        db.rename_column(u'conference_slot', 'kind_id', 'kind')
        # Changing field 'Slot.kind'
        db.alter_column(u'conference_slot', 'kind', self.gf('django.db.models.fields.IntegerField')())
        # Removing index on 'Slot', fields ['kind']
        db.delete_index(u'conference_slot', ['kind_id'])


    def backwards(self, orm):
        # Adding index on 'Slot', fields ['kind']
        db.create_index(u'conference_slot', ['kind_id'])


        # Renaming column for 'Slot.kind' to match new field type.
        db.rename_column(u'conference_slot', 'kind', 'kind_id')
        # Changing field 'Slot.kind'
        db.alter_column(u'conference_slot', 'kind_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))
